...
function ColaboradorEntrada() {
  ...
  const dataRecivedFromAlunoEntrada = [
    { matricula: '123', nome: "João da Silva Freitas", periodo: "3 - 4", box: "140", caixas: [
      {
        "family": "Cirúrgica",
        "quantity": "12"
      }
    ...
    { matricula: '234', nome: "Maria Ferreira", periodo: "9", box: "187", caixas: [
      {
        "family": "Dentística",
        "quantity": "20"
      }
